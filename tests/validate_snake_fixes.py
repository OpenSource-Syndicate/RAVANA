...
async def validate_bug_fix():
    ...
    for success_rate, expected_mood in test_cases:
        ...
        try:
            ...
            if actual_mood == expected_mood:
                print(
                    f"   ✓ Success rate {success_rate} → mood '{actual_mood}' (correct)")
            else:
                print(
                    f"   ⚠ Success rate {success_rate} → mood '{actual_mood}' (expected '{expected_mood}')")
    ...
    print(
        f"   Coding model: unlimited_mode={coding_unlimited}, max_tokens={coding_max_tokens}")
    print(
        f"   Reasoning model: unlimited_mode={reasoning_unlimited}, max_tokens={reasoning_max_tokens}")
