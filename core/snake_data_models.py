...
class ProcessState:
    ...
    process_object: Optional[multiprocessing.Process] = field(
...
class CommunicationMessage:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        data['response_received_at'] = self.response_received_at.isoformat(
        ) if self.response_received_at else None
        return data
...
class SnakeAgentConfiguration:
    ...
    def validate(self) -> List[str]:
        ...
        if self.file_monitor_interval < 0.1:
            issues.append(
                "file_monitor_interval too low (minimum 0.1 seconds)")
